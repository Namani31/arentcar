...
public class CarsService {
    ...
    public List<CarTypes> getCarsByNumWithPaging(String carTypeName, int pageSize, int pageNumber) {
        int offset = (pageNumber - 1) * pageSize;
        return carsMapper.getCarsByNumWithPaging(carTypeName, pageSize, offset);
    }
